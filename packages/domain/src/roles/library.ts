...
const roles: Record<RoleKey, Role> = {
  ...
  [RoleKey.Stopper]: {
    key: RoleKey.Stopper,
    positions: [PositionGroup.Defence],
  ...
  [RoleKey.WingBack]: {
    ...
    positions: [PositionGroup.Defence, PositionGroup.Midfield],
  ...
  [RoleKey.BallWinningMidfielder]: {
    ...
    positions: [PositionGroup.Midfield],
  ...
  [RoleKey.AttackingMidfielder]: {
    ...
    positions: [PositionGroup.Midfield, PositionGroup.Attack],
  ...
  [RoleKey.Winger]: {
    key: RoleKey.Winger,
    positions: [PositionGroup.Attack, PositionGroup.Midfield],
  ...
  [RoleKey.TargetMan]: {
    ...
    positions: [PositionGroup.Attack],
