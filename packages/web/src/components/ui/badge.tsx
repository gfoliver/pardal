  ...
  "inline-flex items-center gap-1 rounded-sm px-1.5 h-[18px] text-2xs font-bold uppercase tracking-caps leading-none",
  {
    variants: {
      variant: {
        ...
        gk: "bg-pos-gk text-[var(--text-on-accent)]",
        def: "bg-pos-def text-[var(--text-on-accent)]",
        mid: "bg-pos-mid text-[var(--text-on-accent)]",
        att: "bg-pos-att text-[var(--text-on-accent)]",
      },
    },
